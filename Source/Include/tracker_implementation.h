...
namespace NTracker
{
    ...
    protected:
        TTrackerAbstract(trackerNumber_t assignedNumber, driverPointer_t driverPointer);
    ...
    public:
        ...
        static ITracker* create_tracker(trackerNumber_t assignedNumber, driverPointer_t driverPointer);

    protected:
        TTrackerSpot(trackerNumber_t assignedNumber, driverPointer_t driverPointer);
    };
    ...
    protected:
        TTrackerSmooth(trackerNumber_t assignedNumber, driverPointer_t driverPointer);
    };
    ...
    protected:
        TTrackerDerivative(trackerNumber_t assignedNumber, driverPointer_t driverPointer);
    };
